      ...
      children: [
        ...
        Padding(
          ...
          child: Container(
            height: 30,
            child: FlatButton(
              color:MyTheme.green_accent_color_e0,
              // 	rgb(50,205,50)
...
//           child: Card(
//             elevation: 3,
//             shape: OutlineInputBorder(borderRadius: BorderRadius.circular(10),borderSide: BorderSide(color: Colors.redAccent,width: .5)),
//             child: Row(
//               mainAxisAlignment: MainAxisAlignment.start,
//               children: [
//                 Padding(
